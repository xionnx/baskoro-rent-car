                ...
                <tbody>
                    <tr>
                        <td rowspan="3" width="16%" class="text-center">
                            <img src="<?= base_url('assets/assets_stisla') ?>/assets/img/logobrc.png" alt="logo" width="80" />
                        </td>
                    ...
                    <tr>
                        <td class="text-center">Jl. Margonda No.8, Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16424, SMS/No. Telp. +62 895322882891, No. WA. +62 895322882891, https://www.baskororentcar.com/</td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <?php foreach ($detail as $dt) : ?>
                        ...
                        <tr>
                            ...
                            ?>
                            <td colspan='3'>
                                <b>*Silahkan transfer Total Biaya Sewa ke 123456789 Bank BCA a/n RAMADHAN ARIFIYANTO maksimal tanggal <?= $batas_bayar ?>. <br>
