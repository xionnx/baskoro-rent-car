								...
								<div class="card">
									...
									<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion_2">
										<div class="card-body">
											...
											<br>
											Bank: <img src="<?= base_url('assets/assets_shop/img/Logo_BCA.png'); ?>" width="80px" height="30px">
											<br>
											No. Rekening: 123456789
											<br>
											Penerima: RAMADHAN ARIFIYANTO
											<br>
											<br>
				...
				<div class="sidebar-content-wrap m-t-50">
					...
					<div class="single-sidebar">
						...
						<div class="sidebar-body">
							...
							<p>Hubungi:</p>
							<p><i class="fa fa-whatsapp"></i> (0895) 322882891</p>
							<p><i class="fa fa-mobile"></i> (0895) 322882891</p>
						</div>
					</div>
					<!-- Single Sidebar End -->
