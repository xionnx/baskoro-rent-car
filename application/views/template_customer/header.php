    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="<?= base_url() ?>assets/assets_shop/img/zeta.gif" alt="JSOFT">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-envelope"></i> baskororentcar@gmail.com
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-whatsapp"></i> (0895) 322882891
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-2 text-center">
                        <i class="fa fa-map-marker"></i> 16424, Kota Depok
                    </div>
                    <!--== Single HeaderTop End ==-->
                        ...
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php if (isset($_SESSION['level']) == 2) { ?>
                                    <li><a href="javascript:;"><img alt="image" src="<?= base_url() . 'assets/upload/gambar_user/' . $_SESSION['gambar_user']; ?>" class="rounded-circle" width='25'
                                    style="margin-rig   ht: 5px"></i> HALO | <?= $_SESSION['nama']; ?></a>
                                        <ul>
