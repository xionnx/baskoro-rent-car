      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <div class="single-footer-widget">
            ...
            <div class="widget-body">
              <ul class="get-touch">
                <li><i class="fa fa-map-marker"></i> Jl. Margonda No.8, Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16424</li>
                <li><i class="fa fa-whatsapp"></i> (0895) 322882891</li>
                <li><i class="fa fa-envelope"></i> baskororentcar@gmail.com</li>
                <li><i class="fa fa-globe"></i> https://www.baskororentcar.com/</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-12 text-center">
          <p>
            ...
            Copyright &copy; Baskoro Rent Car <script>
              document.write(new Date().getFullYear());
            </script> | All rights reserved | made with 💛 by <a href="https://colorlib.com" target="_blank">Colorlib</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
